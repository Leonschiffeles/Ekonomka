...
def display_title():
    gu.tk.Label(gu.frame_Body, text=" K A R T O C H K I ",width=41, bg="grey", fg="red", font=('times', 20, 'bold')).pack(side='top')
...
class Carten:
    def __init__(self):
        ...
        self.dobav_sl()
        self.dobav_zn()
        self.display_cartu = gu.tk.Label(gu.frame_Body, text= self.display_cartu,width=25, height=5,bg="#66B2FF", fg="#FFFFFF", font=('times', 30, 'bold')).pack(side='top')
        self.display_true()
        self.button_u = gu.tk.Button(gu.frame_Button, text="Udalit",width=20, height=2,bg="#66B2FF", fg="#FFFFFF", font=('times', 15, 'bold'))
        self.button_u["command"] = self.button_ud
        self.button_u.grid(row=0, column=0, padx=8,pady=3)
        self.button_d = gu.tk.Button(gu.frame_Button, text="Dalee",width=20, height=2,bg="#66B2FF", fg="#FFFFFF", font=('times', 15, 'bold'))
        self.button_d["command"] = self.button_da
        self.button_d.grid(row=0, column=1, padx=8,pady=3)
        self.button_do = gu.tk.Button(gu.frame_Button, text="Dobavit",width=20, height=2,bg="#66B2FF", fg="#FFFFFF", font=('times', 15, 'bold'))
