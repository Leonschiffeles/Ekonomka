...
def display_title():
    gu.tk.Label(gu.frame_Body, text="  W  I  K  T  O  R  I  N  A  ",
...
class Wiktorin:
    def __init__(self):
        self.w_no = 0
        self.label = gu.tk.Label(gu.frame_Body, text="", width=50,
                                 font=('times', 20, 'bold'))
        display_title()
    ...
    def radio_buttons(self):
        ...
        while len(w_spisok) < 4:
            radio_btn = gu.tk.Radiobutton(gu.frame_Body, text=" ", variable=self.opt_selected,
    ...
    def buttons(self):
        gu.tk.Button(gu.frame_Footer, text="next", command=self.next_btn,
                     width=11, bg='#003C80', fg='#FFFFFF', activebackground='red', activeforeground='#003C80',
                     highlightcolor='grey', font=('Arial', 14, 'bold')).pack()
